...
function dropLogs() {
    ...
    //var inventory_log_color = "72522c" || "815e33" || "3e3529"; //oak log or regular log will be dropped
  ...
  //  if (pixel_color == inventory_log_color) {
     ...
     //   robot.mouseClick();
     //   sleep(1000);
       // console.log("Log color: " + inventory_log_color);
...
function findTree() {
    ...
    var tree_colors = ["654928", "7a5a30", "7d5c32", "513b1f", "6f502b"];
